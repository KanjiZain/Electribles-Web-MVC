    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Login(string username, string password)
        {
            if (username == "admin" && password == "admin")
            {
                ...
                Response.Cookies.Append("AuthCookie", username, new CookieOptions { Expires = DateTimeOffset.UtcNow.AddMonths(1) });
            ...
            if (user != null && VerifyPassword(password, user.Password))
            {
                ...
                Response.Cookies.Append("AuthCookie", user.Username, new CookieOptions { Expires = DateTimeOffset.UtcNow.AddMonths(1) });
